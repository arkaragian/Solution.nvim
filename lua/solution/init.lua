...
solution.setup = function(config)
    ...
    -- Setup the default Build and Platform. If there is cache data those settings will
    -- be overwritten. When a solution is loaded.
...
solution.DisplayExecutionScheme = function()
